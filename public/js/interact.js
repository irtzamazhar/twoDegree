...
(function(m) {
    ...
    function Aa(a, b) {
        b = b || {};
        Sa && Ra(a) ? (sa("screen", a, b), b.x +=
            v.scrollX, b.y += v.scrollY) : sa("page", a, b);
        return b
    }
    function Ta(a, b) {
        b = b || {};
    ...
    function Da(a) {
        var b = [];
        B(a) ? (b[0] = a[0], b[1] = a[1]) : "touchend" === a.type ? 1 === a.touches.length ? (b[0] = a.touches[0], b[1] = a.changedTouches[0]) : 0 === a.touches.length && (b[0] = a.changedTouches[0], b[1] = a.changedTouches[1]) : (b[0] = a.touches[0], b[1] = a.touches[1]);
        return b
    }
    function Va(a) {
        for (var b = {
    ...
    function da(a, b, c) {
        return (a = a.options.allowFrom) ? r(c) ? P(a) ? Ia(c,
            a, b) : r(a) ? ba(a, c) : !1 : !1 : !0
    }
    function Ya(a, b) {
        if (!b) return !1;
    ...
    function ia(a, b, c) {
        for (var d = a.options, e = d[c.name].max, d = d[c.name].maxPerElement, k = 0, h = 0, f = 0, q = 0, G = w.length; q < G; q++) {
            ...
            if (n.interacting() && (k++, k >= va || n.target ===
                    a && (h += t === c.name | 0, h >= e || n.element === b && (f++, t !== c.name || f >= d)))) return !1
        }
        return 0 < va
    }
    function wa() {
        ...
        if (x(Function.prototype.bind)) this.boundInertiaFrame =
            this.inertiaFrame.bind(this), this.boundSmoothEndFrame = this.smoothEndFrame.bind(this);
        else {
            var a = this;
    ...
    function Za(a, b, c) {
        ...
        for (a = 0; a < d; a++)
            if (h = w[a], !(h.prepared.name &&
                    !h.target.options.gesture.enabled || h.interacting() || !e && h.mouse)) return h;
        return new wa
    }
    function $a(a) {
        return function(b) {
            var c, d = Ba(b.path ? b.path[0] : b.target),
            ...
            if (ha && /touch/.test(b.type))
                for (ab = (new Date).getTime(), k = 0; k < b.changedTouches.length; k++) {
                    ...
                    if (c =
                        Za(b, b.type, d)) c._updateEventTargets(d, e), c[a](b, b, d, e)
                }
        }
    }
    function I(a, b, c, d, e, k) {
        ...
        !Ja(h, c) || r && ja && ja.length || (this.snap = {
            ...
            dx: f.dx,
            dy: f.dy
        }, f.locked && (g.x += f.dx, g.y += f.dy, A.x += f.dx, A.y += f.dy));
        !Ka(h, c) || r && p[c].restrict.elementRect || !q.restricted || (g.x += q.dx, g.y += q.dy, A.x += q.dx, A.y += q.dy, this.restrict = {
            dx: q.dx,
            dy: q.dy
        });
        this.pageX = g.x;
        ...
        l ? "client" === n ? (this.dx = A.x - a.startCoords.client.x, this.dy = A.y - a.startCoords.client.y) : (this.dx = g.x - a.startCoords.page.x, this.dy = g.y - a.startCoords.page.y) : r ? this.dy = this.dx = 0 : "inertiastart" === d ? (this.dx = a.prevEvent.dx, this.dy = a.prevEvent.dy) : "client" === n ? (this.dx =
            A.x - a.prevEvent.clientX, this.dy = A.y - a.prevEvent.clientY) : (this.dx = g.x - a.prevEvent.pageX, this.dy = g.y - a.prevEvent.pageY);
        ...
        r ? (this.timeStamp = a.downTimes[0], this.velocityY = this.velocityX = this.speed = this.duration = this.dt = 0) : "inertiastart" === d ? (this.timeStamp = a.prevEvent.timeStamp, this.dt = a.prevEvent.dt, this.duration = a.prevEvent.duration, this.speed = a.prevEvent.speed, this.velocityX = a.prevEvent.velocityX, this.velocityY = a.prevEvent.velocityY) : (this.timeStamp = (new Date).getTime(), this.dt = this.timeStamp - a.prevEvent.timeStamp, this.duration = this.timeStamp - a.downTimes[0], b instanceof I ? (b = this[t] - a.prevEvent[t], z = this[z] - a.prevEvent[z],
            c = this.dt / 1E3, this.speed = ga(b, z) / c, this.velocityX = b / c, this.velocityY = z / c) : (this.speed = a.pointerDelta[n].speed, this.velocityX = a.pointerDelta[n].vx, this.velocityY = a.pointerDelta[n].vy));
        (l || "inertiastart" === d) && 600 < a.prevEvent.speed && 150 > this.timeStamp - a.prevEvent.timeStamp && (d = 180 * Math.atan2(a.prevEvent.velocityY, a.prevEvent.velocityX) / Math.PI, 0 > d && (d += 360), l = 112.5 <= d && 247.5 > d, z = 202.5 <= d && 337.5 > d, this.swipe = {
            up: z,
    ...
    function E(a, b) {
        ...
        } else c = Y(a), r(a, c) && (U ? (n.add(this._element, L.down, l.pointerDown), n.add(this._element, L.move, l.pointerHover)) : (n.add(this._element, "mousedown", l.pointerDown), n.add(this._element, "mousemove", l.pointerHover), n.add(this._element, "touchstart", l.pointerDown), n.add(this._element, "touchmove",
            l.pointerHover)));
        this._doc = c.document; - 1 === y(ka, this._doc) && eb(this._doc);
        D.push(this);
        this.set(b)
    }
    function O(a, b) {
    ...
    function eb(a) {
        if (-1 === y(ka, a)) {
            ...
            U ? (L = gb === b.MSPointerEvent ? {
                ...
                "touchstart", l.selectorDown), n.add(a, "touchmove", l.pointerMove), n.add(a, "touchend", l.pointerUp), n.add(a, "touchcancel", l.pointerCancel), n.add(a, "mousemove", l.autoScrollMove), n.add(a, "touchmove", l.autoScrollMove));
            n.add(b, "blur", fb);
            try {
                if (b.frameElement) {
    ...
    if (m) {
        var v = function() {
            ...
            La = "matches" in Element.prototype ? "matches" : "webkitMatchesSelector" in
            Element.prototype ? "webkitMatchesSelector" : "mozMatchesSelector" in Element.prototype ? "mozMatchesSelector" : "oMatchesSelector" in Element.prototype ? "oMatchesSelector" : "msMatchesSelector",
            la, W = m.requestAnimationFrame,
            ...
            n = function() {
                function a(b, c, d, k) {
                    ...
                    if (g && g.events) {
                        ...
                        if ("all" === c)
                            for (c in g.events) g.events.hasOwnProperty(c) && a(b, c, "all");
                        else {
                            if (g.events[c]) {
                                var r = g.events[c].length;
                                if ("all" === d) {
                                    for (t =
                                        0; t < r; t++) a(b, c, g.events[c][t], !!k);
                                    return
                                }
                                for (t = 0; t < r; t++)
                                    if (g.events[c][t] === d) {
                ...
                return {
                    add: function(a, h, g, l) {
                        ...
                        m || (m = {
                            events: {},
                            typeCount: 0
                        }, t = q.push(a) - 1, G.push(m), n.push(e ? {
                            supplied: [],
                            wrapped: [],
                            useCount: []
                        } : null));
                                ...
                                var t = n[t],
                                    ...
                                    z = t.wrapped[p] || function(e) {
                                        e.immediatePropagationStopped || (e.target = e.srcElement,
                                            e.currentTarget = a, e.preventDefault = e.preventDefault || b, e.stopPropagation = e.stopPropagation || c, e.stopImmediatePropagation = e.stopImmediatePropagation || d, /mouse|click/.test(e.type) && (e.pageX = e.clientX + Y(a).document.documentElement.scrollLeft, e.pageY = e.clientY + Y(a).document.documentElement.scrollTop), g(e))
                                    };
        ...
        wa.prototype = {
            ...
            pointerOver: function(a, b, c) {
                ...
                if (!this.prepared.name &&
                    ...
                    q && !ia(f, c, q) && (q = null);
                    q ? (this.target = f, this.element = c, this.matches = [], this.matchElements = []) : (D.forEachSelector(d), this.validateSelector(a, b, e, k) ? (this.matches = e, this.matchElements = k, this.pointerHover(a, b, this.matches,
                        this.matchElements), n.add(c, U ? L.move : "mousemove", l.pointerHover)) : this.target && (ba(h, c) ? (this.pointerHover(a, b, this.matches, this.matchElements), n.add(this.element, U ? L.move : "mousemove", l.pointerHover)) : (this.element = this.target = null, this.matches = [], this.matchElements = [])))
                }
            },
            ...
            selectorDown: function(a, b, c, d) {
                ...
                this.collectEventTargets(a, b, c,
                    "down")
            },
            pointerDown: function(a, b, c, d, e) {
                if (!e && !this.inertiaStatus.active && this.pointerWasMoved && this.prepared.name) this.checkAndPreventDefault(b, this.target, this.element);
                    ...
                    } else this.prepared.name || (f = D.get(d)) && !ca(f, d, c) && da(f, d, c) &&
                        (h = Z(e || f.getAction(a, b, this, d), f, c)) && ia(f, d, h) && (this.target = f, this.element = d);
            ...
            setStartOffsets: function(a,
                ...
                } else this.startOffset.left = this.startOffset.top = this.startOffset.right = this.startOffset.bottom =
                    0;
                ...
                if (a && c && c.relativePoints && c.relativePoints.length)
                    for (var h = 0; h < c.relativePoints.length; h++) this.snapOffsets.push({
                ...
                a && b.elementRect ? (this.restrictOffset.left = this.startOffset.left - e * b.elementRect.left, this.restrictOffset.top =
                    this.startOffset.top - k * b.elementRect.top, this.restrictOffset.right = this.startOffset.right - e * (1 - b.elementRect.right), this.restrictOffset.bottom = this.startOffset.bottom - k * (1 - b.elementRect.bottom)) : this.restrictOffset.left = this.restrictOffset.top = this.restrictOffset.right = this.restrictOffset.bottom = 0
            },
            start: function(a, b, c) {
                this.interacting() || !this.pointerIsDown || this.pointerIds.length < ("gesture" === a.name ? 2 : 1) || (-1 === y(w, this) && w.push(this), this.prepared.name || this.setEventXY(this.startCoords, this.pointers),
                    this.prepared.name = a.name, this.prepared.axis = a.axis, this.prepared.edges = a.edges, this.target = b, this.element = c, this.setStartOffsets(a.name, b, c), this.setModifications(this.startCoords.page), this.prevEvent = this[this.prepared.name + "Start"](this.downEvent))
            },
            pointerMove: function(a, b, c, d, e) {
                ...
                if (this.pointerIsDown)
                    ...
                    if (this.pointerWasMoved && (!this.inertiaStatus.active || a instanceof I && /inertiastart/.test(a.type))) {
                        if (!this.interacting() && (Qa(this.pointerDelta,
                            ...
                            if ("xy" !== q && "xy" !== d && d !== q) {
                                ...
                                if (!this.prepared.name) {
                                    var n = this;
                                    f = function(a, b, d) {
                                        d = la ? d.querySelectorAll(b) :
                                            void 0;
                                        if (a !== n.target && ua(a, c) && !a.options.drag.manualStart && !ca(a, g, c) && da(a, g, c) && T(g, b, d) && "drag" === a.getAction(n.downPointer, n.downEvent, n, g).name && Ya(q, a) && ia(a, g, "drag")) return a
                                    };
                                    for (g = c; r(g);) {
            ...
            resizeMove: function(a) {
                ...
                if (b) {
                    ...
                    else if (l.top || l.bottom) e =
                        k;
                    b.top && (f.top += k);
                    b.bottom && (f.bottom += k);
                    b.left && (f.left += e);
                    b.right && (f.right += e);
                    d ? (C(q, f), "reposition" === c && (q.top > q.bottom && (b = q.top, q.top = q.bottom, q.bottom = b), q.left > q.right && (b = q.left, q.left = q.right, q.right = b))) : (q.top = Math.min(f.top, h.bottom), q.bottom = Math.max(f.bottom, h.top), q.left = Math.min(f.left, h.right), q.right = Math.max(f.right, h.left));
            ...
            pointerEnd: function(a, b, c, d) {
                ...
                if (this.interacting()) {
                    ...
                    g && !h && (n || m) && (g = {}, g.snap = g.restrict = g, n && (this.setSnapping(this.curCoords.page, g), g.locked && (p += g.dx, r += g.dy)), m && (this.setRestriction(this.curCoords.page, g), g.restricted && (p += g.dx, r += g.dy)), p || r) && (l = !0);
                    if (h || l) {
                        ra(f.upCoords, this.curCoords);
                        this.pointers[0] = f.startEvent = new I(this, b, this.prepared.name, "inertiastart", this.element);
                        f.t0 = q;
                        e.fire(f.startEvent);
                        h ? (f.vx0 = this.pointerDelta.client.vx, f.vy0 = this.pointerDelta.client.vy, f.v0 = k, this.calcInertia(f), b = C({}, this.curCoords.page), e = na(e, this.element),
                            b.x = b.x + f.xe - e.x, b.y = b.y + f.ye - e.y, e = {
                                useStatusXY: !0,
                                x: b.x,
                                y: b.y,
                                dx: 0,
                                dy: 0,
                                snap: null
                            }, e.snap = e, p = r = 0, n && (b = this.setSnapping(this.curCoords.page, e), b.locked && (p += b.dx, r += b.dy)), m && (e = this.setRestriction(this.curCoords.page, e), e.restricted && (p += e.dx, r += e.dy)), f.modifiedXe += p, f.modifiedYe += r, f.i = W(this.boundInertiaFrame)) : (f.smoothEnd = !0, f.xe = p, f.ye = r, f.sx = f.sy = 0, f.i = W(this.boundSmoothEndFrame));
                        f.active = !0;
                        return
                    }(n || m) && this.pointerMove(a, b, c, d, !0)
                }
                this.dragging ? (f = new I(this, b, "drag", "end", this.element),
                    m = this.getDrop(f, b, this.element), this.dropTarget = m.dropzone, this.dropElement = m.element, m = this.getDropEvents(b, f), m.leave && this.prevDropTarget.fire(m.leave), m.enter && this.dropTarget.fire(m.enter), m.drop && this.dropTarget.fire(m.drop), m.deactivate && this.fireActiveDrops(m.deactivate), e.fire(f)) : this.resizing ? (f = new I(this, b, "resize", "end", this.element), e.fire(f)) : this.gesturing && (f = new I(this, b, "gesture", "end", this.element), e.fire(f));
                this.stop(b)
            },
            ...
            getDrop: function(a, b, c) {
                ...
                for (var e = 0; e < this.activeDrops.dropzones.length; e++) {
                    ...
                    d.push(this.activeDrops.dropzones[e].dropCheck(a, b, this.target, c, k, this.activeDrops.rects[e]) ?
                        k : null)
                }
                c = (b = d[0]) ? 0 : -1;
                for (var h, e = [], f, k = 1; k < d.length; k++)
                    ...
                    if (b.parentNode === a.ownerDocument) b = a, c = k;
                        ...
                        if (!e.length)
                            for (h = b; h.parentNode && h.parentNode !== h.ownerDocument;) e.unshift(h), h = h.parentNode;
            ...
            getDropEvents: function(a, b) {
                ...
                this.dropElement !== this.prevDropElement && (this.prevDropTarget && (a.leave = {
                    ...
                    type: "dragleave"
                }, b.dragLeave = this.prevDropElement, b.prevDropzone = this.prevDropTarget), this.dropTarget && (a.enter = {
            ...
            clearTargets: function() {
                this.dropTarget = this.dropElement = this.prevDropTarget = this.prevDropElement =
            ...
            stop: function(a) {
                ...
                this.prepared.name = this.prevEvent =
                    null;
            ...
            addPointer: function(a) {
                var b = Q(a),
                    c = this.mouse ? 0 : y(this.pointerIds, b); - 1 === c && (c = this.pointerIds.length);
                this.pointerIds[c] = b;
                this.pointers[c] = a;
                return c
            },
            removePointer: function(a) {
                a = Q(a);
                a = this.mouse ? 0 : y(this.pointerIds, a); - 1 !== a && (this.pointers.splice(a, 1), this.pointerIds.splice(a, 1), this.downTargets.splice(a,
                    1), this.downTimes.splice(a, 1), this.holdTimers.splice(a, 1))
            },
            ...
            collectEventTargets: function(a, b, c, d) {
                ...
                if ("tap" !== d || !this.pointerWasMoved && this.downTargets[k] && this.downTargets[k] === c) {
                    for (var h = [], f = [], g = c; g;) p.isSet(g) && p(g)._iEvents[d] &&
                        (h.push(p(g)), f.push(g)), D.forEachSelector(e), g = N(g);
            ...
            firePointers: function(a, b, c, d, e, k) {
                var h = this.mouse ? 0 : y(this.pointerIds, Q(a)),
                    f = {};
                "doubletap" === k ? f = a : (qa(f, b), b !== a && qa(f, a), f.preventDefault = bb, f.stopPropagation = I.prototype.stopPropagation, f.stopImmediatePropagation = I.prototype.stopImmediatePropagation, f.interaction = this, f.timeStamp = (new Date).getTime(), f.originalEvent = b, f.originalPointer = a, f.type = k, f.pointerId = Q(a), f.pointerType = this.mouse ?
                    "mouse" : U ? P(a.pointerType) ? a.pointerType : [, , "touch", "pen", "mouse"][a.pointerType] : "touch");
                if ("tap" === k) {
                ...
                l ? (d = {}, C(d, f), d.dt = g, d.type = "doubletap",
                    this.collectEventTargets(d, b, c, "doubletap"), this.prevTap = d) : "tap" === k && (this.prevTap = f)
            },
            ...
            setSnapping: function(a, b) {
                ...
                for (var h = c.targets ? c.targets.length : 0, f = 0; f < this.snapOffsets.length; f++) {
                    ...
                    for (e = 0; e < h; e++)(k = x(c.targets[e]) ? c.targets[e](g, l, this) : c.targets[e]) && d.push({
            ...
            setRestriction: function(a, b) {
                ...
                b.snap &&
                    b.snap.locked && (d.x += b.snap.dx || 0, d.y += b.snap.dy || 0);
                ...
                r(e) && (e = ta(e));
                (a = e) ? "x" in e && "y" in e ? (c = Math.max(Math.min(a.x + a.width - this.restrictOffset.right, d.x), a.x + this.restrictOffset.left), a = Math.max(Math.min(a.y + a.height - this.restrictOffset.bottom, d.y), a.y + this.restrictOffset.top)) :
                    (c = Math.max(Math.min(a.right - this.restrictOffset.right, d.x), a.left + this.restrictOffset.left), a = Math.max(Math.min(a.bottom - this.restrictOffset.bottom, d.y), a.top + this.restrictOffset.top)): (c = d.x, a = d.y);
                b.dx = c - d.x;
                b.dy = a - d.y;
            ...
            checkAndPreventDefault: function(a, b, c) {
                if (b = b || this.target) {
                    ...
                    "auto" === d && c && !/^(input|select|textarea)$/i.test(a.target.nodeName) ?
                        /down|start/i.test(a.type) && "drag" === this.prepared.name && "xy" !== b.drag.axis || b[this.prepared.name] && b[this.prepared.name].manualStart && !this.interacting() || a.preventDefault() : "always" === d && a.preventDefault()
                }
            },
            ...
            autoScrollMove: function(a) {
                ...
                if (b)
                    if (this.inertiaStatus.active) g.x = g.y = 0;
                        ...
                        } else e = Ca(e), k = a.clientX <
                            e.left + g.margin, b = a.clientY < e.top + g.margin, c = a.clientX > e.right - g.margin, a = a.clientY > e.bottom - g.margin;
                        g.x = c ? 1 : k ? -1 : 0;
                        g.y = a ? 1 : b ? -1 : 0;
        ...
        for (var l = {}, ib = "dragStart dragMove resizeStart resizeMove gestureStart gestureMove pointerOver pointerOut pointerHover selectorDown pointerDown pointerMove pointerUp pointerCancel pointerEnd addPointer removePointer recordPointer autoScrollMove".split(" "),
                Oa = 0, Pa = ib.length; Oa < Pa; Oa++) {
            var jb = ib[Oa];
            l[jb] = $a(jb)
        }
        ...
        E.prototype = {
            setOnEvents: function(a, b) {
                "drop" === a ? (x(b.ondrop) &&
                    (this.ondrop = b.ondrop), x(b.ondropactivate) && (this.ondropactivate = b.ondropactivate), x(b.ondropdeactivate) && (this.ondropdeactivate = b.ondropdeactivate), x(b.ondragenter) && (this.ondragenter = b.ondragenter), x(b.ondragleave) && (this.ondragleave = b.ondragleave), x(b.ondropmove) && (this.ondropmove = b.ondropmove)) : (a = "on" + a, x(b.onstart) && (this[a + "start"] = b.onstart), x(b.onmove) && (this[a + "move"] = b.onmove), x(b.onend) && (this[a + "end"] = b.onend), x(b.oninertiastart) && (this[a + "inertiastart"] = b.oninertiastart));
                return this
            },
            ...
            setPerAction: function(a, b) {
                for (var c in b) c in H[a] && (u(b[c]) ? (this.options[a][c] = C(this.options[a][c] || {}, b[c]), u(H.perAction[c]) && "enabled" in H.perAction[c] && (this.options[a][c].enabled = !1 === b[c].enabled ?
                    !1 : !0)) : K(b[c]) && u(H.perAction[c]) ? this.options[a][c].enabled = b[c] : void 0 !== b[c] && (this.options[a][c] = b[c]))
            },
            dropzone: function(a) {
            ...
            dropCheck: function(a, b, c, d, e, k) {
                ...
                g = c.getRect(d);
                if ("center" === f) var h = g.left + g.width / 2,
                    l = g.top + g.height / 2,
                    h = h >= k.left && h <= k.right && l >= k.top && l <= k.bottom;
                F(f) && (h = Math.max(0, Math.min(k.right, g.right) - Math.max(k.left,
                    g.left)) * Math.max(0, Math.min(k.bottom, g.bottom) - Math.max(k.top, g.top)) / (g.width * g.height) >= f);
            ...
            squareResize: function(a) {
                return K(a) ? (this.options.resize.square = a, this) :
                    null === a ? (delete this.options.resize.square, this) : this.options.resize.square
            },
            ...
            setOptions: function(a, b) {
                ...
                if (u(b) || K(b)) {
                    for (d = 0; d < c.length; d++) {
                        ...
                        u(this.options[e]) && (e = this.options[e][a], u(b) ? (C(e, b), e.enabled = !1 === b.enabled ? !1 : !0, "snap" === a && ("grid" === e.mode ? e.targets = [p.createSnapGrid(C({
                            offset: e.gridOffset || {
                                x: 0,
                                y: 0
                            }
                        }, e.grid || {}))] : "anchor" === e.mode ? e.targets = e.anchors : "path" === e.mode && (e.targets = e.paths), "elementOrigin" in b && (e.relativePoints = [b.elementOrigin]))) : K(b) && (e.enabled =
                            b))
                    }
                    return this
                }
            ...
            actionChecker: function(a) {
                return x(a) ? (this.options.actionChecker = a, this) : null === a ? (delete this.options.actionChecker, this) :
            ...
            preventDefault: function(a) {
                return /^(always|never|auto)$/.test(a) ? (this.options.preventDefault =
                    a, this) : K(a) ? (this.options.preventDefault = a ? "always" : "never", this) : this.options.preventDefault
            },
            origin: function(a) {
            ...
            fire: function(a) {
                ...
                if (a.type in X && (d = X[a.type]))
                    for (e = 0, b = d.length; e < b && !a.immediatePropagationStopped; e++) d[e](a);
                return this
            },
            on: function(a, b, c) {
                var d;
                ...
                if (-1 !== y(ea, a)) a in this._iEvents ? this._iEvents[a].push(b) : this._iEvents[a] = [b];
                    ...
                    if (!R[a])
                        for (R[a] = {
                                ...
                                contexts: [],
                                listeners: []
                            }, d = 0; d < ka.length; d++) n.add(ka[d],
                            a, pa), n.add(ka[d], a, ya, !0);
                    a = R[a];
                    for (d = a.selectors.length - 1; 0 <= d && (a.selectors[d] !== this.selector || a.contexts[d] !== this._context); d--); - 1 === d && (d = a.selectors.length, a.selectors.push(this.selector), a.contexts.push(this._context), a.listeners.push([]));
                    ...
                    for (e = g.selectors.length - 1; 0 <= e; e--)
                        if (g.selectors[e] === this.selector && g.contexts[e] === this._context) {
                            ...
                            for (d = f.length - 1; 0 <= d; d--) {
                                ...
                                if (f[d][0] === b && l === c) {
                                    f.splice(d, 1);
                                    f.length || (g.selectors.splice(e, 1), g.contexts.splice(e, 1), g.listeners.splice(e, 1), n.remove(this._context, a, pa),
                                        n.remove(this._context, a, ya, !0), g.selectors.length || (R[a] = null));
                                    h = !0;
                                    break
                                }
                            }
                ...
                if (P(this.selector))
                    for (var a in R)
                        for (var b = R[a]; 0 < b.selectors.length;) {
                            ...
                            break
                        } else n.remove(this, "all"), this.options.styleCursor &&
        ...
        "undefined" !== typeof exports ? ("undefined" !== typeof module && module.exports && (exports = module.exports =
            p), exports.interact = p) : "function" === typeof define && define.amd ? define("interact", function() {
            return p
        }) : m.interact = p
    }
